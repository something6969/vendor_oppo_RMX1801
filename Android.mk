...
include $(CLEAR_VARS)
LOCAL_MODULE := libchromatix_imx371_cpp_snapshot_4m_otherapk
LOCAL_MODULE_OWNER := oppo
LOCAL_SRC_FILES := proprietary/vendor/lib/libchromatix_imx371_cpp_snapshot_4m_otherapk.so
LOCAL_MULTILIB := 32
...
include $(CLEAR_VARS)
LOCAL_MODULE := libchromatix_imx376_cpp_snapshot_5m_otherapk
LOCAL_MODULE_OWNER := oppo
LOCAL_SRC_FILES := proprietary/vendor/lib/libchromatix_imx376_cpp_snapshot_5m_otherapk.so
LOCAL_MULTILIB := 32
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
...
include $(CLEAR_VARS)
LOCAL_MODULE := libchromatix_imx376k_cpp_snapshot_5m_otherapk
LOCAL_MODULE_OWNER := oppo
LOCAL_SRC_FILES := proprietary/vendor/lib/libchromatix_imx376k_cpp_snapshot_5m_otherapk.so
LOCAL_MULTILIB := 32
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
...
include $(CLEAR_VARS)
LOCAL_MODULE := libchromatix_imx476_cpp_snapshot_5m_otherapk
LOCAL_MODULE_OWNER := oppo
LOCAL_SRC_FILES := proprietary/vendor/lib/libchromatix_imx476_cpp_snapshot_5m_otherapk.so
LOCAL_MULTILIB := 32
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
...
include $(CLEAR_VARS)
LOCAL_MODULE := libchromatix_imx576_cpp_snapshot_5m_otherapk
LOCAL_MODULE_OWNER := oppo
LOCAL_SRC_FILES := proprietary/vendor/lib/libchromatix_imx576_cpp_snapshot_5m_otherapk.so
LOCAL_MULTILIB := 32
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
...
include $(CLEAR_VARS)
LOCAL_MODULE := libchromatix_s5k2t7sm_cpp_snapshot_5m_otherapk
LOCAL_MODULE_OWNER := oppo
LOCAL_SRC_FILES := proprietary/vendor/lib/libchromatix_s5k2t7sm_cpp_snapshot_5m_otherapk.so
LOCAL_MULTILIB := 32
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
...
include $(CLEAR_VARS)
LOCAL_MODULE := libchromatix_s5k2t7sp_cpp_snapshot_5m_otherapk
LOCAL_MODULE_OWNER := oppo
LOCAL_SRC_FILES := proprietary/vendor/lib/libchromatix_s5k2t7sp_cpp_snapshot_5m_otherapk.so
LOCAL_MULTILIB := 32
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
